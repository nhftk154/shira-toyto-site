...
## נשאר לעשות
- [ ] **למחוק את 6 ההמלצות הזמניות** ב-`content/testimonials.json` (מסומנות `"sample": true`, לא מוצגות כך באתר) ולהוסיף אמיתיות. אסור להשאיר אותן באתר אחרי קידומו. (לחזור לזה)
