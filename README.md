...
- [ ] **להשלים את השדות המסומנים "[יש להשלים]"** ב-`privacy.html`, `terms.html`, `accessibility.html` (מספר עוסק, אימייל, מחוז שיפוט, תאריך בדיקת נגישות), ולשלוח לעו"ד לאישור סופי.
- [ ] **תיאור לכל תמונת גלריה** (אדמין, גלריה, "תיאור לכל תמונה"), ולא לפרסם ילדים מזוהים בלי הסכמה בכתב.
- [ ] **לאשר בעלות/רישיון** על הלוגו, פריימי האנימציה, `og-image` והטקסטים מהאתר הקודם.
